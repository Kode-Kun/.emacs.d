...
To get this running on a fresh install, install the following packages through MELPA:
** Package list:
 - rainbow-mode
 - evil-mode
 - which-key
...
(custom-set-variables
 ...
 '(package-selected-packages '(evil evil-collection magit rainbow-delimiters which-key)))
(custom-set-faces
